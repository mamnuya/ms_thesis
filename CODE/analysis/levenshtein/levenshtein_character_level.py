...
# Save results
output_identity_file = "../../../data/levenshtein_analysis/character_level/avg_bias_change_by_debiasing_method/average_levenshtein_distance_by_identity.json"
output_language_file = "../../../data/levenshtein_analysis/character_level/avg_bias_change_by_debiasing_method/average_levenshtein_distance_by_method_ALL_languages.json"
...
output_identity_across_languages = "../../../data/levenshtein_analysis/character_level/avg_bias_change_by_debiasing_method/levenshtein_distance_by_identity_ALL_languages.json"
