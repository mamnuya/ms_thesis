...
for lang in languages:
    ...
    file_path = f"../../../data/lexicon_analysis/frequency/normalized_frequency/frequency_analysis_{lang}_mt0xxl_with_complex_and_simple_debiasing.json"
    ...
    save_path = f"../../../data/lexicon_analysis/frequency/bias_change/bias_change_by_debiasing_method/bias_change_{lang}.json"
